...
En Test_Espacial_Figuras_Identicas-labels_es.properties:
Test_Espacial_Figuras_Identicas=Tu aplicación
Test_Espacial_Figuras_Identicas[description]=Tu aplicación hace esto y lo otro

En Test_Espacial_Figuras_Identicas-messages_en.properties:
