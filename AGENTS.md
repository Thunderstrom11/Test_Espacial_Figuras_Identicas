...
- Crea la clase de la acción en el paquete `com.testEspacial.Test_Espacial_Figuras_Identicas.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.testEspacial.Test_Espacial_Figuras_Identicas.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.testEspacial.Test_Espacial_Figuras_Identicas.acciones;
...
- ✅ Coloca las clases de acción en `com.testEspacial.Test_Espacial_Figuras_Identicas.acciones`
...
```java
package com.testEspacial.Test_Espacial_Figuras_Identicas.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.testEspacial.Test_Espacial_Figuras_Identicas.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
